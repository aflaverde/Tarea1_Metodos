...
#print (ult_20) #Imprime los 20 ultimos anios con temps - Es una lista

###Crea una lista con los 20 anios mas calientes
years_hot=[]
for l in ult_20:
	years_hot.append(l[0])
print (years_hot)
###Crea una lista con las 20 temps mas calientes
T_hot=[]
for l in ult_20:
	T_hot.append(l[1])
...
plt.suptitle('Temperatura suavizada y 20 mas calientes vs. Anio')
plt.legend()
